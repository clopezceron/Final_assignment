...
def make_statistics(frecuencias, frecuencias_lemas, diccionario):
...
def show_total_statistics(numero_palabras_diccionario,numero_palabras,numero_palabras_distintas,numero_lemas_distintos,numero_palabras_unicas, numero_lemas_unicos, top_palabras, top_lemas.   print("The dictionary used cointain ", numero_palabras_diccionario," words")
